...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonalData.userpic'
        db.add_column(u'accounts_personaldata', 'userpic',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonalData.userpic'
        db.delete_column(u'accounts_personaldata', 'userpic')
